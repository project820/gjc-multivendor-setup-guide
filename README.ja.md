...
> **ベンチマーク基準日：2026-07-02**（Claude 5 ファミリーのリリース直後に再検証）。† 推論軸の更新：**GPT-5.6 Sol は 2026-07-09 に GA** — v2 カタログで planner 軸の世代交代は反映済み（[§6-2](#6-2-役割配置の最適性レビューdeep-research--実測)）。architect 軸は Gemini 3.5 Pro（2M 文脈、Deep Think）が 7月 GA に延期 — リリース時に再検証予定。
